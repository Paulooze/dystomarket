...
export const makeCompaniesData = (map) => [
  ...
  },
  {
    ...
    ceo: map.get("Shaddam Corrino IV"),
  },
  {
  ...
  },
  {
    ...
    ceo: map.get("Mooby the Golden Calf"),
  },
  {
    name: "Pizza Planet",
    tickerSymbol: "PLNT",
  ...
  },
  {
    ...
    ceo: map.get("Howard K. Duff VIII"),
  },
  {
